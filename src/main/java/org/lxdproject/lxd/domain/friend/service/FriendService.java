package org.lxdproject.lxd.domain.friend.service;
...
import org.lxdproject.lxd.global.authz.guard.FriendGuard;
...
import org.lxdproject.lxd.domain.friend.repository.FriendRequestRepository;
...
public class FriendService {
    ...
    public void sendFriendRequest(Long requesterId, FriendRequestCreateRequestDTO requestDto) {
        ...
        boolean alreadyFriends = friendRepository.areFriends(requester.getId(), receiver.getId());
        if (alreadyFriends) {
